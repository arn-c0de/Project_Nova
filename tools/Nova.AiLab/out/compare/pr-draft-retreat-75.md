...
Kandidat `retreat-75` — geändert gegenüber `ms1-canonical`: retreatAt 60→75%.

| Kennzahl | ms1-canonical | retreat-75 |
|---|---:|---:|
| Siegrate | 50% | 50% |
| Partien (S/N/U) | 1/1/0 | 1/1/0 |
| Entscheidungstick (Mittel) | 5931 | 14475 |
| Credits am Ende (Mittel) | 17100 | 46280 |
| Armeegröße am Ende (Mittel) | 10 | 7 |
| Verlorene Einheiten (Mittel) | 35 | 79 |
| Intents gesendet | 308 | 826 |
...
| Kennzahl | ms1-canonical | retreat-75 |
|---|---:|---:|
| Austauschverhältnis (Feindverluste je 100 eigene) | 123 | 166 |
| Gefechtsintervalle (mit Verlusten) | 10 | 25 |
| Grösster Verlustsprung in einem Intervall | 9 | 7 |
| Reaktionslatenz (Ticks Schaden → neuer Marschbefehl) | 116 | 146 |
| Unbeantworteter Schaden (Ereignisse) | 35 | 72 |
