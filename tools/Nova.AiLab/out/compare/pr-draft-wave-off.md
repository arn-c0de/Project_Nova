...
Kandidat `wave-off` — geändert gegenüber `ms1-canonical`: waveSize 12→1.

| Kennzahl | ms1-canonical | wave-off |
|---|---:|---:|
| Siegrate | 50% | 50% |
| Partien (S/N/U) | 1/1/0 | 1/1/0 |
| Entscheidungstick (Mittel) | 5931 | 11389 |
| Credits am Ende (Mittel) | 17100 | 31070 |
| Armeegröße am Ende (Mittel) | 10 | 8 |
| Verlorene Einheiten (Mittel) | 35 | 100 |
| Intents gesendet | 308 | 1093 |
...
| Kennzahl | ms1-canonical | wave-off |
|---|---:|---:|
| Austauschverhältnis (Feindverluste je 100 eigene) | 123 | 82 |
| Gefechtsintervalle (mit Verlusten) | 10 | 46 |
| Grösster Verlustsprung in einem Intervall | 9 | 7 |
| Reaktionslatenz (Ticks Schaden → neuer Marschbefehl) | 116 | 48 |
| Unbeantworteter Schaden (Ereignisse) | 35 | 96 |
| Aktionen pro Minute | 15 | 28 |
