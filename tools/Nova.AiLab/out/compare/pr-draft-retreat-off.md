...
Kandidat `retreat-off` — geändert gegenüber `ms1-canonical`: retreatAt 60→0%.

| Kennzahl | ms1-canonical | retreat-off |
|---|---:|---:|
| Siegrate | 50% | 50% |
| Partien (S/N/U) | 1/1/0 | 1/1/0 |
| Entscheidungstick (Mittel) | 5931 | 7929 |
| Credits am Ende (Mittel) | 17100 | 22470 |
| Armeegröße am Ende (Mittel) | 10 | 9 |
| Verlorene Einheiten (Mittel) | 35 | 62 |
| Intents gesendet | 308 | 476 |
...
| Kennzahl | ms1-canonical | retreat-off |
|---|---:|---:|
| Austauschverhältnis (Feindverluste je 100 eigene) | 123 | 93 |
| Gefechtsintervalle (mit Verlusten) | 10 | 20 |
| Grösster Verlustsprung in einem Intervall | 9 | 7 |
| Reaktionslatenz (Ticks Schaden → neuer Marschbefehl) | 116 | 33 |
| Unbeantworteter Schaden (Ereignisse) | 35 | 59 |
