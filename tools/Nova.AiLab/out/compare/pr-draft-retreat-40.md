...
Kandidat `retreat-40` — geändert gegenüber `ms1-canonical`: retreatAt 60→40%.

| Kennzahl | ms1-canonical | retreat-40 |
|---|---:|---:|
| Siegrate | 50% | 50% |
| Partien (S/N/U) | 1/1/0 | 1/1/0 |
| Entscheidungstick (Mittel) | 5931 | 8429 |
| Credits am Ende (Mittel) | 17100 | 24885 |
| Armeegröße am Ende (Mittel) | 10 | 10 |
| Verlorene Einheiten (Mittel) | 35 | 63 |
| Intents gesendet | 308 | 521 |
...
| Kennzahl | ms1-canonical | retreat-40 |
|---|---:|---:|
| Austauschverhältnis (Feindverluste je 100 eigene) | 123 | 116 |
| Gefechtsintervalle (mit Verlusten) | 10 | 19 |
| Grösster Verlustsprung in einem Intervall | 9 | 8 |
| Reaktionslatenz (Ticks Schaden → neuer Marschbefehl) | 116 | 66 |
| Unbeantworteter Schaden (Ereignisse) | 35 | 55 |
| Aktionen pro Minute | 15 | 18 |
