...
Kandidat `retreat-25-near` — geändert gegenüber `ms1-canonical`: retreatAt 60→25%, retreatDanger 8→4.

| Kennzahl | ms1-canonical | retreat-25-near |
|---|---:|---:|
| Siegrate | 50% | 50% |
| Partien (S/N/U) | 1/1/0 | 1/1/0 |
| Entscheidungstick (Mittel) | 5931 | 6675 |
| Credits am Ende (Mittel) | 17100 | 18450 |
| Armeegröße am Ende (Mittel) | 10 | 9 |
| Verlorene Einheiten (Mittel) | 35 | 45 |
| Intents gesendet | 308 | 397 |
...
| Kennzahl | ms1-canonical | retreat-25-near |
|---|---:|---:|
| Austauschverhältnis (Feindverluste je 100 eigene) | 123 | 98 |
| Gefechtsintervalle (mit Verlusten) | 10 | 15 |
| Grösster Verlustsprung in einem Intervall | 9 | 7 |
| Reaktionslatenz (Ticks Schaden → neuer Marschbefehl) | 116 | 40 |
| Unbeantworteter Schaden (Ereignisse) | 35 | 41 |
| Aktionen pro Minute | 15 | 16 |
